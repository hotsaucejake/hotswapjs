...
<link rel="stylesheet" href="/angular/styles-5INURTSO.css"><style ng-app-id="ng">[_nghost-ng-c245922056] {
  ...
  p[_ngcontent-ng-c245922056] {
    margin: 0;
    color: var(--gray-700);
  }

  main[_ngcontent-ng-c245922056] {
    width: 100%;
    min-height: 100%;
    display: flex;
  ...
  .angular-logo[_ngcontent-ng-c245922056] {
    max-width: 9.2rem;
  }

  .content[_ngcontent-ng-c245922056] {
    display: flex;
  ...
  .content[_ngcontent-ng-c245922056]   h1[_ngcontent-ng-c245922056] {
    margin-top: 1.75rem;
  }

  .content[_ngcontent-ng-c245922056]   p[_ngcontent-ng-c245922056] {
    margin-top: 1.5rem;
  }

  .divider[_ngcontent-ng-c245922056] {
    width: 1px;
    background: var(--red-to-pink-to-purple-vertical-gradient);
    margin-inline: 0.5rem;
  }

  .pill-group[_ngcontent-ng-c245922056] {
    display: flex;
  ...
  .pill[_ngcontent-ng-c245922056]:hover {
    background: color-mix(in srgb, var(--pill-accent) 15%, transparent);
  }

  .pill-group[_ngcontent-ng-c245922056]   .pill[_ngcontent-ng-c245922056]:nth-child(6n + 1) {
    --pill-accent: var(--bright-blue);
  }
  .pill-group[_ngcontent-ng-c245922056]   .pill[_ngcontent-ng-c245922056]:nth-child(6n + 2) {
    --pill-accent: var(--french-violet);
  }
  .pill-group[_ngcontent-ng-c245922056]   .pill[_ngcontent-ng-c245922056]:nth-child(6n + 3), 
   .pill-group[_ngcontent-ng-c245922056]   .pill[_ngcontent-ng-c245922056]:nth-child(6n + 4), 
   .pill-group[_ngcontent-ng-c245922056]   .pill[_ngcontent-ng-c245922056]:nth-child(6n + 5) {
    --pill-accent: var(--hot-red);
  }

  .pill-group[_ngcontent-ng-c245922056]   svg[_ngcontent-ng-c245922056] {
    margin-inline-start: 0.25rem;
  }

  .social-links[_ngcontent-ng-c245922056] {
    display: flex;
    align-items: center;
    gap: 0.73rem;
    margin-top: 1.5rem;
  ...
  .social-links[_ngcontent-ng-c245922056]   path[_ngcontent-ng-c245922056] {
    transition: fill 0.3s ease;
    fill: var(--gray-400);
  }

  .social-links[_ngcontent-ng-c245922056]   a[_ngcontent-ng-c245922056]:hover   svg[_ngcontent-ng-c245922056]   path[_ngcontent-ng-c245922056] {
    fill: var(--gray-900);
  }
